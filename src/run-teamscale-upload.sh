...
if [[ "$OS" == "Windows" ]]; then
  curl -L https://github.com/cqse/teamscale-upload/releases/download/v2.9.4/teamscale-upload-windows.zip -o teamscale-upload.zip
  unzip teamscale-upload.zip;
else
  wget -O teamscale-upload.zip https://github.com/cqse/teamscale-upload/releases/download/v2.9.4/teamscale-upload-linux.zip;
  unzip teamscale-upload.zip
fi
